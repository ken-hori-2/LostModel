...
class neural():
    ...
    def graph(self, index, data_node):
        ...
        # length = len (seikika_node)
        # if length == 1:
        #     color_maps_node = [cm_n(seikika_node[0])]
        # elif length == 2:
        #     color_maps_node = [cm_n(seikika_node[0]), cm_n(seikika_node[1])]
        # elif length == 3:
        #     color_maps_node = [cm_n(seikika_node[0]), cm_n(seikika_node[1]), cm_n(seikika_node[2])]
        # else:
        #     color_maps_node = [cm_n(seikika_node[0]), cm_n(seikika_node[1]), cm_n(seikika_node[2]), cm_n(seikika_node[3])]
