...
class Algorithm_exp_re():
    ...
    def Explore_re(self, STATE_HISTORY, state, TRIGAR, total_stress, grid, Storage, CrossRoad, x): # , PERMISSION):
        ...
        while not self.done:
            ...
            if self.total_stress >= PERMISSION[index][0]                    +x: # or self.lost:
                self.TRIGAR = True
                print("=================")
                print("FULL ! MAX! 🔙⛔️")
                print("=================")
